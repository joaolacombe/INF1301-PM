...
*		4.00   gg,gs,jg  28/03/2016	 Alteração de métodos para o recebimento de
									 ponteiro para árvore como parâmetro e
									 alteração no nó da árvore para armazenamento de 
									 um ponteiro de uma lista de caracteres.
...
***********************************************************************/
   ...
   typedef struct tgNoArvore{
         ...
         LIS_tppLista* Valor ;
               /* Valor do nó, uma lista de caracteres. */
...
/***** Protótipos das funções encapuladas no módulo *****/
   ...
   static tpNoArvore * CriarNo(LIS_tppLista* ValorParm);

   static ARV_tpCondRet CriarNoRaiz(tpArvore* pArvore, LIS_tppLista* ValorParm);
...
*  ****/
   ...
   ARV_tpCondRet ARV_InserirEsquerda(tpArvore* pArvore, LIS_tppLista* ValorParm)
   {
...
*  ****/
   ...
   ARV_tpCondRet ARV_InserirDireita(tpArvore* pArvore, LIS_tppLista* ValorParm)
   {
...
*  ****/
   ...
   ARV_tpCondRet ARV_ObterValorCorr(tpArvore* pArvore, int * ValorParm)
   {
      ...
      *ValorParm = (int)(pArvore->pNoCorr->Valor) ;
...
***********************************************************************/
   ...
   tpNoArvore * CriarNo(LIS_tppLista* ValorParm)
   {
      tpNoArvore * pNo ;
...
***********************************************************************/
   ...
   ARV_tpCondRet CriarNoRaiz(tpArvore* pArvore, LIS_tppLista* ValorParm)
   {
      ARV_tpCondRet CondRet ;
      tpNoArvore * pNo ;
      if (pArvore == NULL)
