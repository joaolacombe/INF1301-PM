...
*	   5.00   gg,gs,jg   28/mar/2016 Alteração do tipo do valor na estrutura. 
...
*
*  $EP Parâmetros
*    $P pLista  - é o parâmetro que receberá o ponteiro para a lista
*				  a ser manipulada.
*				  Este parâmetro é passado por referência.
*
*    $P pElem   - é o parâmetro do elemento a ser excluido.
*				 Este parâmetro é passado por referência.
*
***********************************************************************/
